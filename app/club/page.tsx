...
const videos = [
  {
    ...
    title: "ナイトクラブ動画 第1位",
    views: "－",
    description: "クラブの爆盛り上がりシーンがそのまま収録された衝撃動画。「こんな空間実在するの？」とコメ欄が騒然。夜遊び勢には刺さりすぎる神回。",
  ...
  },
  {
    ...
    title: "ナイトクラブ動画 第2位",
    views: "－",
    description: "渋谷・六本木系クラブのリアルな内側を映した話題作。フロアの熱気とそこで起きるハプニングが包み隠さず収録されている。",
    color: "text-gray-300",
  },
  {
    rank: 3,
    ...
    title: "ナイトクラブ動画 第3位",
    views: "－",
    description: "クラブ初心者には刺激が強すぎる内容。「こういう世界があるのか」と驚きのコメントが殺到した問題作。経験者は懐かしさで泣く。",
  ...
  },
  {
    ...
    title: "ナイトクラブ動画 第4位",
    views: "－",
    description: "夜の出会いの最前線がここにある。クラブ特有の開放的な雰囲気の中で起きるナンパ・出会いシーンがリアルすぎてドキドキが止まらない。",
    color: "text-pink-400",
  },
];
    ...
    <div className="bg-gray-900 text-gray-200 font-sans min-h-screen">
      ...
      <section className="bg-gray-800 text-center py-10 px-4 border-b border-gray-700">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-4xl font-extrabold mb-4 leading-tight text-white">
            夜の聖地、クラブの真実。<br />
            <span className="text-pink-500" style={{ textShadow: '0 0 5px #ec4899, 0 0 10px #ec4899' }}>ナイトクラブ</span>動画ランキング
          </h2>
          <p className="text-gray-400 mb-4 text-sm md:text-base">
            渋谷・六本木・大阪のクラブシーンを完全密着。普通では見られないリアルな夜の世界を厳選まとめ。
          </p>
          <p className="text-gray-500 text-xs leading-relaxed">
            ナイトクラブ / クラブ / 夜遊び / 出会い / ナンパ / クラブ女子 / 六本木 / 渋谷 / まとめ
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 max-w-3xl pb-16 mt-8">
        ...
        <h3 className="flex items-center text-xl font-bold border-l-4 border-pink-500 pl-3 mb-6 text-white">
          <Crown className="text-yellow-500 mr-2" size={24} /> ナイトクラブ動画ランキング
        </h3>
